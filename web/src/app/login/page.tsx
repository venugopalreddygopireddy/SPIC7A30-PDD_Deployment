  ...
  return (
    <div className="min-h-screen bg-[#050810] flex items-center justify-center font-sans text-slate-200">
      <div className="max-w-md w-full p-8 flex flex-col items-center">
        ...
        <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-cyan-500 rounded-full mb-8 shadow-lg shadow-emerald-500/20 flex items-center justify-center text-[#050810] font-bold text-2xl">
          C
        </div>
